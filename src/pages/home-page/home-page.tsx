    ...
    return (
        <div id="page-wrapper">
            <section id="banner">
                <div className="inner">
                    <picture>
                        <img className="logo" src={Black_Ice} width="450px" height="266px" alt="Black_Ice" />
                    </picture>
            ...
            <section id="wrapper">
                <section id="one" className="wrapper spotlight">
                    <div className="inner">
                        <Link to="/about" className="image image-none-border-radius">
                ...
                <section id="two" className="wrapper alt spotlight style2">
                    <div className="inner">
                        <Link to="/training" className="image">
                            <img src={Trainings} width="100%" height="100%" alt="" />
                        </Link>
                        <div className="content">
                            ...
                            <Link to="/training" className="special">
                                Тренироваться
                            </Link>
                        </div>
                    </div>
                ...
                <section id="three" className="wrapper  spotlight style3">
                    <div className="inner">
                        <Link to="/school" className="image">
                            <img src={School} width="100%" height="100%" alt="" />
                        </Link>
                        <div className="content">
                            ...
                            <Link to="/school" className="special">
                                Учиться
                            </Link>
                        </div>
                    </div>
                ...
                <section id="four" className="wrapper alt spotlight">
                    <div className="before"></div>
                    <div className="inner">
                        <Link to="/travels" className="image">
                            <img src={Travels} width="100%" height="100%" alt="" />
                        </Link>
                        <div className="content">
                            <h2 className="major">Альпсборы</h2>
                            <p>Какой же альпинизм без восхождений? Поехали в горы с нами.</p>
                            <Link to="/travels" className="special">
                                Поехать с нами
                            </Link>
                        </div>
                    </div>
