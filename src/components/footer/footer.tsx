            ...
            <div className="inner">
                ...
                <ul className="contact">
                    ...
                    <li className="icon solid fa-envelope">
                        <a target="_blank" href="mailto:blackicealpclub@gmail.com" rel="noreferrer">
                            blackicealpclub@gmail.com
                        </a>
                    </li>
                    <li className="icon brands fa-vk">
                        <a target="_blank" href="https://vk.com/black_ice_alpinizm" rel="noreferrer">
                    ...
                    <li className="icon brands fa-instagram">
                        <a target="_blank" href="https://www.instagram.com/blackiceclub/" rel="noreferrer">
                            @blackiceclub
                        </a>
                    </li>
                </ul>
                <div className="copyright flex">
                    <a className="flex" target="_blank" href="https://github.com/AprilBoy" rel="noreferrer">
                        &copy; Night Walrus Production&nbsp;
                        <img src={Walrus} width="24px" height="24px" alt="Night Walrus" />
                    </a>
                </div>
            </div>
        </footer>
